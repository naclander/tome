...
ifeq ($(config),debug)
  OBJDIR     = ../obj/Debug/luabitop
  TARGETDIR  = ../bin/Debug
  TARGET     = $(TARGETDIR)/libluabitop.a
...
$(OBJDIR)/bit.o: ../src/luabitop/bit.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
