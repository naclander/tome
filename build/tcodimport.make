...
ifeq ($(config),debug)
  OBJDIR     = ../obj/Debug/tcodimport
  TARGETDIR  = ../bin/Debug
  TARGET     = $(TARGETDIR)/libtcodimport.a
...
$(OBJDIR)/noise_c.o: ../src/libtcod_import/noise_c.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
