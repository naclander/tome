...
ifeq ($(config),debug)
  OBJDIR     = ../obj/Debug/luamd5
  TARGETDIR  = ../bin/Debug
  TARGET     = $(TARGETDIR)/libluamd5.a
...
$(OBJDIR)/ldes56.o: ../src/luamd5/ldes56.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
$(OBJDIR)/md5.o: ../src/luamd5/md5.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
$(OBJDIR)/des56.o: ../src/luamd5/des56.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
$(OBJDIR)/md5lib.o: ../src/luamd5/md5lib.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o "$@" -c "$<"
